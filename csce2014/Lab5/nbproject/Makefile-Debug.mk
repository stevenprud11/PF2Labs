...
${OBJECTDIR}/_ext/4785872b/student_list.o: ../../Downloads/student_list.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4785872b/student_list.o ../../Downloads/student_list.cpp

${OBJECTDIR}/_ext/4785872b/student_node.o: ../../Downloads/student_node.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/4785872b
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4785872b/student_node.o ../../Downloads/student_node.cpp

${OBJECTDIR}/_ext/4785872b/student_test.o: ../../Downloads/student_test.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/4785872b
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4785872b/student_test.o ../../Downloads/student_test.cpp
